...
• `{i}ping`
    Verifique el tiempo de respuesta de Dextrov.
...
• `{i}logs`
    Obtenga las últimas 100 líneas de los registros de heroku.

• `{i}usage`
    Obtener detalles de uso de la aplicación.
