...
• `{i}sticker <query>`
    Buscar pegatinas según tu deseo.

• `{i}getaudio <reply to an audio>`
    Descargar audio para poner en tu video/gif deseado.

• `{i}addaudio <reply to Video/gif>`
    Pondrá el audio anterior al video/gif respondido.

• `{i}dob <date of birth>`
    Poner solo en formato dd / mm / aa (por ejemplo, .dob 01/01/1999).

• `{i}wall <query>`
    Buscar fondo de pantalla de alta definición como Per ur Wish..
"""
