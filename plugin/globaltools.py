...
• `{i} gban <usuario / nombre de usuario de respuesta>`
    Prohibir globalmente al usuario.

• `{i} ungban <usuario / nombre de usuario de respuesta>`
    Eliminar la prohibición a nivel mundial.

• `{i} gmute <responder usuario / nombre de usuario>`
    Silenciar globalmente al usuario.

• `{i} ungmute <responder usuario / nombre de usuario>`
    Activar silencio a nivel mundial.

• `{i} gkick <responder usuario / nombre de usuario>`
    Usuario globalmente pateado.

• `{i} gcast <Message>`
    Envíe globalmente ese mensaje en todos los grupos.

• `{i} gucast <Message>`
    Envíe globalmente ese mensaje a todos los usuarios de Ur Chat.
"""
