...
• `{i}ugdrive <reply/file name>`
    Responder al archivo para cargarlo en Google Drive.
    Agregue el nombre del archivo para cargarlo en Google Drive.

• `{i}drivesearch <file name>`
    Busque el nombre del archivo en Google Drive y obtenga el enlace.

• `{i}udir <directory name>`
    Sube un directorio en Google Drive.

• `{i}listdrive`
    Muestra todos los archivos de GDrive.

• `{i}gfolder`
    Enlace a su carpeta de Google Drive.
    Si se agrega, todos los archivos cargados se colocarán aquí.
"""
