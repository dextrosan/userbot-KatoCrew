...
• `{i}addsnip <word><reply to a message>`
    agregue la palabra usada como recorte relacionado con el mensaje respondido.

• `{i}remsnip <word>`
    Elimina la palabra cortada..

• `{i}listsnip`
    enumerar todos los recortes.

• Use :
    type `$(ur snip word)` obtener respuesta configurada.
"""
import os
