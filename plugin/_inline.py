...
ULTROID_PIC = "https://telegra.ph/KATO-CREW-05-02"
...
async def e(o):
    if len(o.text) == 0:
        ...
        header = udB.get("ALIVE_TEXT") if udB.get("ALIVE_TEXT") else "Hey, estoy vivo."
        ...
        res = [
            await b.article(
                title="Kato Crew Userbot",
                url="https://t.me/andraxteam",
                description="Dextrov | Kato Cew ",
                text=ALIVEMSG,
                thumb=InputWebDocument(ULTROID_PIC, 0, "https://i.ibb.co/6FZGQ2G/2.jpg", []),
                buttons=[
        ...
        await o.answer(res, switch_pm=f"👥 KATO PORTAL", switch_pm_param="start")
